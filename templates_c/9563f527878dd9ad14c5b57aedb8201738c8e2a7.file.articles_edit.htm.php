<?php /* Smarty version Smarty-3.0.6, created on 2011-03-18 11:56:28
         compiled from "style/articles_edit.htm" */ ?>
<?php /*%%SmartyHeaderCode:268704d831e3c374aa9-84418564%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9563f527878dd9ad14c5b57aedb8201738c8e2a7' => 
    array (
      0 => 'style/articles_edit.htm',
      1 => 1300438530,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '268704d831e3c374aa9-84418564',
  'function' => 
  array (
  ),
...
<tr><td class="td_right">عنوان المقال</td><td><input type="text" name="title" value="<?php echo $_smarty_tpl->getVariable('article')->value['title'];?>
" /></td></tr>
...
" <?php if ($_smarty_tpl->getVariable('cats')->value[$_smarty_tpl->getVariable('smarty')->value['section']['tp']['index']]['id']==$_smarty_tpl->getVariable('article')->value['cat_id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->getVariable('cats')->value[$_smarty_tpl->getVariable('smarty')->value['section']['tp']['index']]['title'];?>
</option>
<?php endfor; endif; ?>
</select>
</td></tr>
<tr><td class="td_right">المقال</td><td><textarea name="article" class="ckeditor"><?php echo $_smarty_tpl->getVariable('article')->value['article'];?>
</textarea></td></tr>
<tr><td class="td_right">تاريخ الإضافة</td><td><input type="text" name="add_date" value="<?php echo $_smarty_tpl->getVariable('article')->value['add_date'];?>
" /></td></tr>
<tr><td class="td_right">المصدر</td><td><input type="text" name="source" value="<?php echo $_smarty_tpl->getVariable('article')->value['source'];?>
" /></td></tr>
<tr><td class="td_right">عدد القراءات</td><td><input type="text" name="views" value="<?php echo $_smarty_tpl->getVariable('article')->value['views'];?>
" /></td></tr>
<tr><td class="td_right">تفعيل المقال</td><td>
<?php if ($_smarty_tpl->getVariable('article')->value['status']==1){?>
